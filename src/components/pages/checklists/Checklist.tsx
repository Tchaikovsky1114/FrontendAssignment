...
const Checklist = ({ checklists, updateChecklistChanges, deleteChecklist, onFocusInput }: Props) => {
  const {width} = useWindowDimensions();
  const completedChecklistCount = checklists.filter(checklist => checklist.isCompleted).length;
